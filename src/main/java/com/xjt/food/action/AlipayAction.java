...
import com.xjt.food.utils.AlipayConfig;
...
public class AlipayAction {
	...
	public void alipay(HttpServletResponse response,HttpServletRequest request,String os_id,Model model1) throws IOException{
		...
		orderitemsServiceImpl.updateOrderitemsStatus(os_id1);
		Orderitems os = orderitemsServiceImpl.queryOrderitemsByOsId(os_id1);
