...
import com.xjt.food.entity.Expense;
import com.xjt.food.entity.ExpenseTableModel;
import com.xjt.food.entity.Layui;
import com.xjt.food.service.IExpenseService;
...
public class ExpenseAction {
	...
	public @ResponseBody
    Layui queryAllExpense(Model model, HttpSession session, PageUtils page){
