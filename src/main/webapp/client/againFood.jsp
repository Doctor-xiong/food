...
<div id="w">
    <c:forEach items="${os1.oiList }" var="oi" varStatus="index">
        <div id="menu">
            <!-- 图片 -->
            <div id="menu-img">
                <img alt="菜品" src="${pageContext.request.contextPath }${oi.menu.m_img }" height="80px;" width="110px;"
    ...
    <c:if test="${os1 == null }">
        <div>
            <img alt="空空如也" src="${pageContext.request.contextPath }/img/001.jpg" width="50%;" height="30%"
