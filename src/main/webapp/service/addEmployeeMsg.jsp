        ...
        <form class="layui-form layui-from-pane" id="emp" style="margin-top:25px">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="e_name" id="e_name" placeholder="请输入姓名"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 250px">
                    <input style="width: 250px;" type="text" name="e_password" id="e_password" placeholder="请输入6-18位密码"
                           lay-verify="required" autocomplete="off" class="layui-input" onblur="pwvalidate(this);">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input style="width: 250px;" type="text" name="e_regdate" id="date1" autocomplete="off"
                               class="layui-input" placeholder="点击选择入职时间">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="e_tel" id="e_tel" placeholder="请输入联系电话"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="e_address" id="e_address" placeholder="请输入地址"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="e_salary" id="e_salary" placeholder="请输入工资"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" style="margin-top:30px">
                <div class="layui-input-block">
                    <button id="btn-add" class="layui-btn layui-btn-lg layui-btn-warm " lay-submit=""
                            lay-filter="demo11">确认添加
                    </button>
                </div>
            </div>
        </form>
