        ...
        <form id="fm" class="layui-form layui-from-pane" style="margin-top:25px">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="m_id" required lay-verify="required"
                           autocomplete="off" class="layui-input" readonly="readonly" value="${menu.m_id}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">菜品名称</label>
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" name="m_name" required lay-verify="required"
                           autocomplete="off" class="layui-input" value="${menu.m_name}">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input style="width: 250px;" type="text" name="m_price" required lay-verify="required"
                           autocomplete="off" class="layui-input" value="${menu.m_price}">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div style="margin-top:20px;margin-left:35px;width:150px;float:left">
                    <button type="button" class="layui-btn" id="test1"
                            style="background-color: #5FB878;margin-right: 10px;">
                        <i class="layui-icon">&#xe67c;</i>更换图片
                    </button>
                </div>
                <div id="pic" style="float:left;"><input type="hidden" name="m_img" class="layui-input"
                                                         value="${menu.m_img}"></div>
                <div class="layui-upload-list" id="updateImg" style="float:left;overflow-y:auto;">
                    <img width="200" height="100" src="${pageContext.request.contextPath }${menu.m_img}"
                         class="layui-upload-img" style="margin-bottom: 2px;">
                </div>
            </div>
