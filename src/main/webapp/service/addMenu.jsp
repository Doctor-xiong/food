...
<div class="layui-col-md12" style="margin-top:60px;padding-top:20px">
    <div style="color:white;">
        <center><h1>新增菜品</h1></center>
    </div>
    <div style="width:50%;margin:50px auto">
        <form class="layui-form layui-form-pane" action="${pageContext.request.contextPath }/addNewMenu.action"
              method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">菜品</label>
                <div class="layui-input-block">
                    <input type="text" name="m_name" required lay-verify="required" placeholder="请输入菜品名"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="m_price" lay-verify="required" placeholder="请输入价格" autocomplete="off"
                           class="layui-input">
                </div>
