        ...
        <form class="layui-form layui-from-pane" id="expense" style="margin-top:25px">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" id="ex_name" name="ex_name" placeholder="请输入支出名"
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input style="width: 250px;" type="text" name="ex_regtime" id="date1" autocomplete="off"
                               class="layui-input" placeholder="点击选择支出时间">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" id="ex_other" name="ex_other" placeholder="请输入支出详情"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 250px;" type="text" id="ex_price" name="ex_price" placeholder="请输入支出金额"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
