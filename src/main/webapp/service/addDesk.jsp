    ...
    <form id="fm" class="layui-form layui-from-pane" style="margin-top:25px">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="width: 250px;" type="text" name="d_name" required lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="width: 250px;" type="text" name="d_password" required lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="width: 250px;" type="text" name="d_type" required lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input style="width: 250px;" type="text" name="d_place" required lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
