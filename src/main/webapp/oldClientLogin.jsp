...
<body>
<div id="q" class="layui-col-xs18 layui-col-sm6 layui-col-md4" style="text-align: center">
    <form class="layui-form" action="${pageContext.request.contextPath }/clientLogin.action">
        ...
        <div class="layui-form-item" style="text-align: center">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit style="width: 50% ;text-align: center">立即提交</button>
